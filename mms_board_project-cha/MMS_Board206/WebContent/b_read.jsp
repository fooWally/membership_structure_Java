...
<c:when test="${login.id == dto.author}" >
	...
	<a href="bdeleteui.do?num=${dto.num}" >삭제</a> 
	<a href="breplyui.do?num=${dto.num}">답글</a>
	<a href="blist.do">목록</a>
</c:when>
<c:otherwise>
	<a href="bread.do?num=${dto.num}" onclick="alert('작성자가 아닙니다')">수정</a>
	<a href="bread.do?num=${dto.num}" onclick="alert('작성자가 아닙니다')">삭제</a> 
	<a href="breplyui.do?num=${dto.num}">답글</a>
	<a href="blist.do">목록</a>
</c:otherwise>
</c:choose>
